...
//         CREATE DATABASE APO_TEST_DATA_MODEL
//         )
//     `;
...
//     const createDatabaseQuery = `
//         USE  APO_TEST_DATA_MODEL
//         )
//     `;
//     pool.query(useDatabase, (err, result) => {
//         if (err) {
//             console.error("Error creating 'user' table:", err.message);
//         } else {
//             console.log("Table 'user' created successfully!");
...
export const addUserToDatabase = (user_password, user_role, username, first_name, last_name) => {


    // SQL INSERT query to add data to the 'user' table
    const insertQuery = 'INSERT INTO user (user_password, User_Role, Username, first_name, last_name) VALUES (?, ?, ?, ?, ?)';

    // Data to be inserted
    const data = [user_password, user_role, username, first_name, last_name];
...
export const addData = () => {
    ...
    addUserToDatabase('admin', 'admin', 'admin', 'Manikanta', 'Kosiganti');
    addUserToDatabase('user', 'user', 'user', 'Srikar', 'Satya');
}
